          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(AppIcons.people, "drawerlandlord.tenants".tr,
                      selectedItem == "Tenants"),
                  _buildDrawerItem(AppIcons.booking,
                      "drawerlandlord.bookings".tr, selectedItem == "Receipt"),
                  _buildDrawerItem(AppIcons.payments,
                      "drawerlandlord.payments".tr, selectedItem == "Premium"),
                  _buildDrawerItem(AppIcons.settings,
                      "drawerlandlord.settings".tr, selectedItem == "Settings"),
                ],
              ),
            ),
            // Logout Button
            Padding(
              ...
              child: _buildDrawerItem(
                  Icons.logout, "drawerlandlord.logout".tr, false,
                  color: Colors.red),
            ),
          ],
        ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          onTap: () async {
            if (title == "drawerlandlord.logout".tr) {
